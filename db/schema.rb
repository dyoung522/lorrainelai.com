...
ActiveRecord::Schema[8.1].define(version: 2026_01_12_233428) do
  ...
  create_table "custom_social_platforms", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.string "name", null: false
    ...
    t.index ["site_profile_id", "position"], name: "index_custom_social_platforms_on_site_profile_id_and_position"
    t.index ["site_profile_id"], name: "index_custom_social_platforms_on_site_profile_id"
  end
  ...
  add_foreign_key "custom_social_platforms", "site_profiles"
